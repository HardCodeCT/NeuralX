...
A real-time screen-streaming pipeline, windows operarting system buid[prototype]: capture → change/motion detection → adaptive encoding → TCP transport → AI-upscaled reconstruction.
